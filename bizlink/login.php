...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">sign in</h4>
	<p class="">Hello, Welcome to your Bizlink Account.</p>
...
?>
        ...
        <a href="http://localhost/bizlink/admin/" > <button type="button" class="btn-upper btn btn-primary checkout-page-button" name="login"> 	Admin</button> </a>
	</form>					
</div>
<!-- Sign-in -->
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Create your own Bizlink Account.</p>
