...
$ret=mysql_query("SELECT password FROM admin WHERE username='$username'");
...
<body>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; 2017 Bizlink Portal </b> All rights reserved.
		</div>
	</div>
